...
import { BaseDashPaymentsConfig, AddressType, SinglesigAddressType, AddressTypeT } from './types'
...
export function toBitcoinishConfig<T extends BaseDashPaymentsConfig>(config: T): BitcoinishPaymentsConfig {
