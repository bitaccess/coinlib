import { AddressMultisigData } from './../../payments-common/src/types';
...
import { CreateTransactionOptions, ResolveablePayport, BaseMultisigData, PayportOutput, MultisigData, UtxoInfo } from '@faast/payments-common'
