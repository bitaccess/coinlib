(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bignumber.js'), require('ethereumjs-tx'), require('web3'), require('lodash'), require('@faast/payments-common'), require('@faast/ts-common'), require('request-promise-native'), require('ethereumjs-util'), require('bip32'), require('crypto'), require('elliptic'), require('io-ts')) :
  typeof define === 'function' && define.amd ? define(['exports', 'bignumber.js', 'ethereumjs-tx', 'web3', 'lodash', '@faast/payments-common', '@faast/ts-common', 'request-promise-native', 'ethereumjs-util', 'bip32', 'crypto', 'elliptic', 'io-ts'], factory) :
  (global = global || self, factory(global.faastEthereumPayments = {}, global.bignumber_js, global.ethereumjsTx, global.Web3, global.lodash, global.paymentsCommon, global.tsCommon, global.request, global.ethereumjsUtil, global.bip32, global.crypto, global.elliptic, global.t));
}(this, (function (exports, bignumber_js, ethereumjsTx, Web3, lodash, paymentsCommon, tsCommon, request, ethereumjsUtil, bip32, crypto, elliptic, t) { 'use strict';
