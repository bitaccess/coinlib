...
import { UHdEthereumPayments } from '../src/UHdEthereumPayments'
import { SEED_ACCOUNT_FIXTURE } from './fixtures/accounts'
...
const CONFIG = {
  ...
  hdKey: SEED_ACCOUNT_FIXTURE.xprv,
  seed: SEED_ACCOUNT_FIXTURE.seed,
  logger,
}

const BIP44 = EthereumBIP44.fromXKey(SEED_ACCOUNT_FIXTURE.xprv)
...
// methods from base
describe('UHdEthereumPayments', () => {
  let hdEP: UHdEthereumPayments

  beforeEach(() => {
    hdEP = new UHdEthereumPayments(CONFIG)
  })
  ...
  describe('BaseEthereumPayments methods', () => {
    ...
    describe('getFullConfig', () => {
      test('returns full config', () => {
        expect(hdEP.getFullConfig()).toStrictEqual({
    ...
    describe('signTransaction', () => {
      test('signs transaction and returns data', async () => {
        ...
        expect(res).toStrictEqual({
          id: '0xac774bf12ad5c2e395680f43a0166e24dab2b2bb06891c17ff8965ab42487c15',
          status: 'signed',
          fromAddress: FROM_ADDRESS.toLowerCase(),
          toAddress: to.address.toLowerCase(),
          toExtraId: null,
          ...
          data: {
            ...
            to: '0x3d4717ade8fe244d28c413b979ae8f8273116271',
            v: '0x29',
