(function (global, factory) {
    ...
    (factory((global.moneroPayments = {}),global.TronWeb,global.lodash,global.bitcoreLib,global.jsSha3,global.jsSHA,global.elliptic));
    ...
    ***************************************************************************** */
                    ...
                    switch (_d.label) {
                        ...
                        case 2:
                            ...
                            return [2, {
                                    ...
                                    date: date,
                                    status: status,
                                    raw: __assign({}, tx, txInfo, { currentBlock: lodash.pick(currentBlock, 'block_header', 'blockID') })
                                }];
                        case 3:
                            e_7 = _d.sent();
                            throw toError(e_7);
    ...
    exports.BROADCAST_SUCCESS_CODES = BROADCAST_SUCCESS_CODES;
...
//# sourceMappingURL=monero-payments.umd.js.map
